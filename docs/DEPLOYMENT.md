...
> 📦 See [PYTHON_SETUP.md](./PYTHON_SETUP.md) for detailed Python & package installation instructions.
...
### Or build on the server (if Node.js 18+ is available):
...
*See also: [PYTHON_SETUP.md](./PYTHON_SETUP.md) | [MOBILE_BUILD.md](./MOBILE_BUILD.md) | [ARCHITECTURE.md](./ARCHITECTURE.md)*
