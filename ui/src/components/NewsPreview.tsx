...
export default function NewsPreview() {
  ...
  useEffect(() => {
    fetch(apiUrl('/news?page=1&limit=6'))
      .then(res => {
    ...
    <section id="news" className="news-section section-padding">
      <div className="container">
        <div className="section-header">
          ...
          <p className="section-subtitle">Read newspaper reports, press releases, and media coverage of our social and trade union activities.</p>
        </div>
            ...
            {news.map((item) => (
              <div key={item.id} className="news-card glass-card">
                ...
                <div className="news-card-body">
                  ...
                  <p className="news-card-excerpt">{item.text.length > 100 ? `${item.text.substring(0, 100)}...` : item.text}</p>
